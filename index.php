...
<html>
<head>
	<title>EGN Generator Bulgaria</title>
	<meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
	<meta name="author" content="">
	<style type="text/css">
	<!--
		body    { background: black; color: lime; font: 11pt Verdana,Arial,Helvetica,sans-serif; }
		a       { color: lime; text-decoration: underline; padding:3px; border:1px solid #A3CEE7; }
		a:hover { background: darkgray; text-decoration: underline; border:1px solid blue; }
		h2      { margin:0px; }
		h3      { margin-bottom:0px; }
		.result { background:black; padding:4px; }
		li.result { background:black; }
		form    { margin:0px; }
	-->
	</style>
</head>
